...
export interface MiniMintERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MiniMintERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): MiniMintERC721;
  waitForDeployment(): Promise<this>;

  interface: MiniMintERC721Interface;
  ...
  filters: {
    ...
    "NFTBurned(address,uint256)": TypedContractEvent<
      NFTBurnedEvent.InputTuple,
      NFTBurnedEvent.OutputTuple,
      NFTBurnedEvent.OutputObject
    >;
